...
const Nosotros = () => {
    return (
        <>
            <img src="/images/nosotros1.jpg" class="nosotros__banner"></img>
            <div class="nosotros">
                <h2 class="nosotros__titulo">¡Bienvenidos a Star Contigo!</h2>
                <p class="nosotros__parrafoPresentacion">¡Hola! Me presento, Mi nombre es Brisa, soy la
                ...
                <div class="nosotros__fondoRosa">
                    <img src="/images/nosotros2.jpg" class="nosotros__imagenRosa" />
                    <p class="nosotros__parrafos margen">star contigo es Una tienda de regalos
                        dedicada con mucho amor y dedicación
                        para cada uno de ustedes</p>
                </div>
                <div class="nosotros__fondoNegro">
                    <p class="nosotros__parrafos negro">es un emprendimiento que nació en plena
                    ...
                    <img src="/images/nosotros3.jpg" class="nosotros__imagenNegro" />
                </div>
                <div class="nosotros__fondoRosa">
                    <img src="/images/nosotros4.jpg" class="nosotros__imagenRosa" />
                    <p class="nosotros__parrafos">Realizamos Mapas Estelares, un plano que
